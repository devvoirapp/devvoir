...
>(({ className = '', ...props }, ref) => (
  <SwitchPrimitives.Root
    className={`
      ...
      focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-purple-500 focus-visible:ring-offset-2
      disabled:cursor-not-allowed
      data-[state=checked]:bg-linear-to-r data-[state=checked]:from-purple-500 data-[state=checked]:to-blue-500
