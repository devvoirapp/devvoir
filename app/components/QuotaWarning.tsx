...
//             <div
//                 className="relative bg-white/90 backdrop-blur-xs rounded-xl border border-purple-100/50 shadow-lg overflow-hidden">
//                 <div
//                     className="absolute top-0 left-0 right-0 h-0.5 bg-linear-to-r from-purple-500 via-blue-500 to-purple-500 bg-[length:200%_100%] animate-gradient"/>
//
...
//                                     <span
//                                         className="text-3xl font-semibold bg-linear-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">
//                                         {remaining}
//                                     </span>
...
//                             <div
//                                 className="absolute inset-y-0 left-0 bg-linear-to-r from-purple-500 to-blue-500 transition-all duration-500"
